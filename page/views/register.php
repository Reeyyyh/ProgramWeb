...
<head>
    ...
    <link rel="stylesheet" href="/../testProject/assets/css/register.css">
</head>
<body>
    <div class="container">
                ...
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="text-center mt-3">
                            <p>Sudah punya akun? <a href="login.php" class="text-decoration-none text-primary">Login di sini</a></p>
                        </div>
                    </div>
                </div>
            </div>
